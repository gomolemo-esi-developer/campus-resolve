...
const ComplaintSyncLanding = () => {
  ...
  const CAMPUS_VOICE_URL =
    import.meta.env.VITE_CAMPUS_VOICE_URL || "http://localhost:8082";
  const CAMPUS_RESOLVE_URL =
    import.meta.env.VITE_CAMPUS_RESOLVE_URL || "http://localhost:8083";
  const CAMPUS_ADMIN_URL =
    import.meta.env.VITE_CAMPUS_ADMIN_URL || "http://localhost:8084";
  ...
  const features = [
    {
      ...
      content:
        "Instant notifications and live tracking keep students, staff, and administrators informed on complaint status at Tshwane University of Technology (TUT).",
    },
    {
      id: "escalation",
      icon: GitBranch,
      ...
      content:
        "Automatic routing based on complaint severity and type. Multi-tier approval workflows ensure proper oversight. Clear accountability chains from filing to resolution.",
    },
    {
      id: "ai",
      icon: Bot,
      ...
      content:
        "Smart suggestions based on complaint type, automatic categorization and routing, and natural language processing for quick initial handling. The AI continuously improves from past resolved cases and draws on TUT-specific policies, guidelines, and documentation to provide accurate, context-relevant recommendations.",
    },
    {
      id: "security",
      icon: Lock,
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            <div className="rounded-lg bg-[#1a1a1a] flex items-center justify-center p-1">
              <img
                src={companyLogo}
                alt=""
      ...
      <section
        id="hero"
        className="pt-32 pb-20 px-4 hero-gradient min-h-[90vh] flex items-center"
      >
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            {/* Animated Logo */}
            <div className="animate-scale-in mb-8">
              <div className="w-20 h-20 mx-auto rounded-2xl bg-primary flex items-center justify-center shadow-lg p-2">
                <img
                  src={companyLogo}
                  alt=""
            ...
            <p
              className="text-xl md:text-2xl text-muted-foreground mb-4 animate-fade-in-up opacity-0 delay-200"
            ...
            <p
              className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in-up opacity-0 delay-300"
              style={{ animationFillMode: "forwards" }}
            >
              A structured escalation system for academic, non-academic, and
              technical complaints at Tshwane University of Technology (TUT).
              Issues are routed through clear levels for quicker and more
              accountable resolutions.
            </p>

            {/* CTA Buttons */}
            <div
              className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up opacity-0 delay-400"
              style={{ animationFillMode: "forwards" }}
            >
              <Button
                size="lg"
            ...
            {/* Decorative Nodes */}
            <div
              className="mt-16 relative h-24 animate-fade-in opacity-0 delay-500"
              style={{ animationFillMode: "forwards" }}
            >
              <svg
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Select the portal that matches your role at TUT to access
              personalized tools.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-card">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Join TUT's integrated complaint management system. Get started in
            minutes.
          </p>
          <Button
            size="lg"
      ...
      <footer className="bg-foreground text-background py-16 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-background/60">
                Streamlining complaint management at Tshwane University of
                Technology.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-background/60">
              © 2025 TUT Resolve. Tshwane University of Technology. All rights
              reserved.
            </p>
