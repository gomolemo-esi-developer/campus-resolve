-- =============================================
-- DELETE ALL STAFF DATA (Use this instead of TRUNCATE)
-- Run this in Supabase SQL Editor
-- =============================================

-- First check if there are related tables with foreign keys
SELECT
    tc.table_schema, 
    tc.table_name, 
    kcu.column_name, 
...
-- If there are related records, delete them first or use CASCADE
-- Try deleting with CASCADE again:
DROP TABLE IF EXISTS staff CASCADE;

-- Recreate the staff table with all columns
CREATE TABLE staff (
...
(
    ...
    '["b0000000-0000-0000-0000-000000000003", "b0000000-0000-0000-0000-000000000004"]'::jsonb,
...
(
    ...
    '[]'::jsonb,
    '["b0000000-0000-0000-0000-000000000005", "b0000000-0000-0000-0000-000000000006", "b0000000-0000-0000-0000-000000000007", "b0000000-0000-0000-0000-000000000008"]'::jsonb,
...
(
    ...
    '["b0000000-0000-0000-0000-000000000001", "b0000000-0000-0000-0000-000000000007"]'::jsonb,
...
(
    ...
    '["b0000000-0000-0000-0000-000000000001", "b0000000-0000-0000-0000-000000000002", "b0000000-0000-0000-0000-000000000003", "b0000000-0000-0000-0000-000000000004", "b0000000-0000-0000-0000-000000000005"]'::jsonb,
